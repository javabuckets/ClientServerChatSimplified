...
public class GUIChatClient extends GUIScreen {
    ...
    private void drawMenuBar() {
        ...
        // Th-CC
        GuiUtil.addMenuItem(menus[0], "Connect", KeyEvent.VK_C, "Opens the connect interface", (ActionEvent) -> {
            new GUIServerConnector();
        });
        ...
        // Exit
        GuiUtil.addMenuItem(menus[4], "Exit", KeyEvent.VK_E, "Exit Application", (ActionEvent) -> {
            System.exit(0);
        });
